    ...
    <div className={styles.changePassword}>
      <div className={styles.divbody}>
        ...
        <div className={styles.frameParent}>
            ...
            <div className={styles.dashboard3}>
              ...
              >
                <img
                  ...
                  src="/divcss1i0ek3m.svg"
                />
                <div className={styles.changePassword4}>Change Password</div>
              </button>
          ...
          <form className={styles.divcss9fov8p} target>
            <div className={styles.changePassword5}>Change Password</div>
            <div className={styles.divcssMpz2h1margin}>
              <div className={styles.form}>
                ...
                <div className={styles.group}>
                  <div className={styles.oldPassword}>Confirm New Password</div>
                  <input
                    className={styles.input1}
                    placeholder="Password"
                    type="text"
                ...
                <button className={styles.button1}>
                  <div className={styles.changePassword6}>Change Password</div>
                </button>
              </div>
            </div>
          </form>
        ...
        <div className={styles.footer}>
            ...
            <div className={styles.footerRight}>
              ...
              <div className={styles.vectorParent}>
                ...
                <img
                  className={styles.bitcoinBtcLogo1Icon}
                  alt=""
                  src="/bitcoinbtclogo-111@2x.png"
                />
                <img className={styles.dogeIcon} alt="" src="/doge11@2x.png" />
              </div>
          ...
          <div className={styles.footerLogos}>
            <img
              ...
              alt=""
              src="/section--link--image244@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image245@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image246@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image247@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image248@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image249@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image250@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image251@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image252@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image253@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image254@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image255@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image256@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image257@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image258@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image259@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image260@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image261@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image262@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image263@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image264@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image265@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image266@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image267@2x.png"
            />
          </div>
