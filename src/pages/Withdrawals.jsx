            ...
            <div className={styles.finance}>
              ...
              <button className={styles.account2}>
                <img
                  ...
                  src="/divcss1i0ek3m3.svg"
                />
                <div className={styles.withdrawals2}>Withdrawals</div>
              </button>
            </div>
          </div>
          <div className={styles.divcssDxt16dParent}>
            <div className={styles.divcssDxt16d}>
              <div className={styles.heading2}>
                <div className={styles.withdrawals3}>Withdrawals</div>
                ...
                <div className={styles.grid}>
                  <div className={styles.presentationagHeader}>
                    <div className={styles.row}>
                      ...
                      <div className={styles.columnheader}>
                        <div className={styles.date}>Address</div>
                      </div>
                      <div className={styles.columnheader}>
            ...
            <div className={styles.divcss0}>
              <div className={styles.divcss0Child} />
        ...
        <div className={styles.footer}>
          <div className={styles.rectangleContainer}>
            ...
            <div className={styles.pages}>
              <div className={styles.heading21}>Pages</div>
            ...
            <div className={styles.promotions3}>
              <div className={styles.heading21}>Promotions</div>
            ...
            <div className={styles.heading2PlatformsParent}>
              <div className={styles.heading21}>Platforms</div>
