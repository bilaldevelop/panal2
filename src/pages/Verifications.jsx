    ...
    <div className={styles.verifications}>
      <div className={styles.divbody}>
        <div className={styles.topMenu}>
          ...
          <div className={styles.svgviewerPngOutput21Parent}>
            <img
              ...
              alt=""
              src="/svgviewerpngoutput-2-16@2x.png"
            />
            <div className={styles.frame}>
              <img
                className={styles.svgviewerPngOutput1Icon}
                alt=""
                src="/svgviewerpngoutput-17@2x.png"
              />
            </div>
        ...
        <div className={styles.sidebarParent}>
          ...
          <div className={styles.divcss10ns1gz}>
            <div className={styles.heading5margin}>
              <div className={styles.verifications3}>Verifications</div>
            </div>
            <div className={styles.separatormargin}>
              <div className={styles.separator} />
            </div>
            <div className={styles.divverificationDashboard}>
                ...
                <div className={styles.grid}>
                  <div className={styles.presentationagHeader}>
                    <div className={styles.row}>
                      ...
                      <div className={styles.columnheader1}>
                        <div className={styles.type}>Action</div>
                      </div>
                    </div>
                  </div>
                  <div className={styles.rowgroup}>
                    <div className={styles.rowPressSpaceToSelectTh}>
                      <div className={styles.gridcell}>
                        <div className={styles.div4}>2023-11-04</div>
                      </div>
                      <div className={styles.gridcell}>
                        <div className={styles.photoOfThe}>
                          Photo of the back of ID card
                        </div>
                      </div>
                      <div className={styles.gridcell2}>
                        <div className={styles.photoOfThe}>pending</div>
                      </div>
                    ...
                    <div className={styles.rowPressSpaceToSelectTh1}>
                      <div className={styles.gridcell}>
                        <div className={styles.photoOfThe}>2023-11-04</div>
                      </div>
                      <div className={styles.gridcell}>
                        <div className={styles.photoOfThe}>
                          Photo of the front of ID card
                        </div>
                      </div>
                      <div className={styles.gridcell2}>
                        <div className={styles.photoOfThe}>pending</div>
                      </div>
                      <div className={styles.divagReactContainer1}>
                        <div className={styles.link2}>
                          <div className={styles.browse}>Browse</div>
                        </div>
                      </div>
                    </div>
                    <div className={styles.rowPressSpaceToSelectTh2}>
                      <div className={styles.gridcell}>
                        <div className={styles.div4}>2023-11-04</div>
                      </div>
                      <div className={styles.gridcell7}>
                        <div className={styles.photoOfThe}>
                          Photo of yourself holding your ID card
                        </div>
                      </div>
                      <div className={styles.gridcell}>
                        <div className={styles.photoOfThe}>pending</div>
        ...
        <div className={styles.footer}>
            ...
            <div className={styles.footerRight}>
              ...
              <div className={styles.vectorParent}>
                ...
                <img
                  className={styles.bitcoinBtcLogo1Icon}
                  alt=""
                  src="/bitcoinbtclogo-16@2x.png"
                />
                <img className={styles.dogeIcon} alt="" src="/doge6@2x.png" />
              </div>
          ...
          <div className={styles.footerLogos}>
            <img
              ...
              alt=""
              src="/section--link--image124@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image125@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image126@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image127@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image128@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image129@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image130@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image131@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image132@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image133@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image134@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image135@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image136@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image137@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image138@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image139@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image140@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image141@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image142@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image143@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image144@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image145@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image146@2x.png"
            />
            <img
              className={styles.sectionLinkImage1}
              alt=""
              src="/section--link--image147@2x.png"
            />
          </div>
